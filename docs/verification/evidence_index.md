...
1. **Phase & Architecture Evidence Reports ([`docs/evidence/`](file:///home/jim/mobile_base/docs/evidence/)):** 12 structured technical reports covering runtime closures, hardware preflight, controlled motion characterization, scan decoupling, launch entry optimization, and baseline investigations.
...
The following table catalogs all 12 surviving files in [`docs/evidence/`](file:///home/jim/mobile_base/docs/evidence/):
